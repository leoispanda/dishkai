const APP_VERSION = "DishKAI v0.2.32-public-beta";
...
function renderKnowledgeCard(item) {
  ...
  const coverageNotice = card.verified === false && card.metadataSource === "dishkai-coverage" ? `<p class="notice">${t("coverageGenerated")}</p>` : "";
