...
export const expandedDishes = [
  ...
  starterDish({
    ...
    "shortDescription": {
      "en": "Duck leg slow-cooked in fat until tender, often crisped before serving.",
      "zh": "油封鸭腿 是常见法餐菜单菜品，重点适合用来判断口味、分量和点餐风险。",
      "nl": "Confit de canard is een veelvoorkomend gerecht in de frans keuken, beschreven voor snelle bestelkeuzes."
    },
    "cookingProfile": {
      "en": "Usually served as a meat with a tender meat, rich sauce feel.",
      "zh": "通常以meat形式上桌，重点体验是tender meat。",
    ...
    "cuisineRole": {
      ...
      "description": {
        "en": "A high-frequency French menu item added for broader restaurant coverage.",
        "zh": "为提升餐厅菜单覆盖率加入的高频法餐菜品。",
        "nl": "Een vaak voorkomend frans menu-item voor bredere restaurantdekking."
      }
    },
    "composition": [
      [
    ...
    "orderVerdict": {
      "en": "Order if you want rich, salty, tender duck with crisp skin.",
      "zh": "如果你接受这类口味和风险，油封鸭腿 是可以优先考虑的选择。",
      "nl": "Een goede keuze als je deze smaak en risico’s prima vindt."
    },
    "spiceLevel": 0,
    "weightLevel": 4,
  ...
  starterDish({
    ...
    "shortDescription": {
      "en": "Steak served with fries, usually simple, hearty, and sauce-dependent.",
      "zh": "牛排薯条 是常见法餐菜单菜品，重点适合用来判断口味、分量和点餐风险。",
      "nl": "Steak frites is een veelvoorkomend gerecht in de frans keuken, beschreven voor snelle bestelkeuzes."
    },
    "cookingProfile": {
      "en": "Usually served as a meat with a tender meat, rich sauce feel.",
      "zh": "通常以meat形式上桌，重点体验是tender meat。",
    ...
    "avoidIfTags": [],
    "orderVerdict": {
      "en": "A straightforward French bistro order; ask about sauce and doneness.",
      "zh": "如果你接受这类口味和风险，牛排薯条 是可以优先考虑的选择。",
      "nl": "Een goede keuze als je deze smaak en risico’s prima vindt."
    },
    "spiceLevel": 0,
    "weightLevel": 3,
  ...
  starterDish({
    ...
    "shortDescription": {
      "en": "Snails usually baked with garlic-herb butter.",
      "zh": "法式焗蜗牛 是常见法餐菜单菜品，重点适合用来判断口味、分量和点餐风险。",
      "nl": "Escargots is een veelvoorkomend gerecht in de frans keuken, beschreven voor snelle bestelkeuzes."
    },
    "cookingProfile": {
      "en": "Usually served as a starter with a small bites, contrasting textures feel.",
      "zh": "通常以starter形式上桌，重点体验是small bites。",
    ...
    "avoidIfTags": [],
    "orderVerdict": {
      "en": "Try if you like garlic butter and do not mind a chewy shellfish-like texture.",
      "zh": "如果你接受这类口味和风险，法式焗蜗牛 是可以优先考虑的选择。",
      "nl": "Een goede keuze als je deze smaak en risico’s prima vindt."
    },
    "spiceLevel": 0,
    "weightLevel": 2,
  ...
  starterDish({
    ...
    "shortDescription": {
      "en": "Deep onion broth topped with bread and melted cheese.",
      "zh": "法式洋葱汤 是常见法餐菜单菜品，重点适合用来判断口味、分量和点餐风险。",
      "nl": "Franse uiensoep is een veelvoorkomend gerecht in de frans keuken, beschreven voor snelle bestelkeuzes."
    },
    "cookingProfile": {
      "en": "Usually served as a soup with a hot broth, soft pieces feel.",
      "zh": "通常以soup形式上桌，重点体验是hot broth。",
    ...
    "avoidIfTags": [],
    "orderVerdict": {
      "en": "Comforting and savory, but not light because of bread and cheese.",
      "zh": "如果你接受这类口味和风险，法式洋葱汤 是可以优先考虑的选择。",
      "nl": "Een goede keuze als je deze smaak en risico’s prima vindt."
    },
    "spiceLevel": 0,
    "weightLevel": 3,
  ...
  starterDish({
    ...
    "shortDescription": {
      "en": "Salad with tuna, egg, vegetables, olives, and often potato or beans.",
      "zh": "尼斯沙拉 是常见法餐菜单菜品，重点适合用来判断口味、分量和点餐风险。",
      "nl": "Salade niçoise is een veelvoorkomend gerecht in de frans keuken, beschreven voor snelle bestelkeuzes."
    },
    "cookingProfile": {
      "en": "Usually served as a salad with a fresh crunch, cool finish feel.",
      "zh": "通常以salad形式上桌，重点体验是fresh crunch。",
    ...
    "avoidIfTags": [],
    "orderVerdict": {
      "en": "Good lighter meal if fish and egg are fine.",
      "zh": "如果你接受这类口味和风险，尼斯沙拉 是可以优先考虑的选择。",
      "nl": "Een goede keuze als je deze smaak en risico’s prima vindt."
    },
    "spiceLevel": 0,
    "weightLevel": 2,
  ...
  starterDish({
    ...
    "shortDescription": {
      "en": "Grilled ham and cheese sandwich, often rich with béchamel.",
      "zh": "法式火腿奶酪三明治 是常见法餐菜单菜品，重点适合用来判断口味、分量和点餐风险。",
      "nl": "Croque monsieur is een veelvoorkomend gerecht in de frans keuken, beschreven voor snelle bestelkeuzes."
    },
    "cookingProfile": {
    ...
    "avoidIfTags": [],
    "orderVerdict": {
      "en": "A heavy comfort snack; avoid if no pork, dairy, or gluten.",
      "zh": "如果你接受这类口味和风险，法式火腿奶酪三明治 是可以优先考虑的选择。",
      "nl": "Een goede keuze als je deze smaak en risico’s prima vindt."
    },
    "spiceLevel": 0,
    "weightLevel": 3,
  ...
  starterDish({
    ...
    "shortDescription": {
      "en": "Hearty bean stew with duck, sausage, or pork depending on region.",
      "zh": "法式豆焖肉 是常见法餐菜单菜品，重点适合用来判断口味、分量和点餐风险。",
      "nl": "Cassoulet is een veelvoorkomend gerecht in de frans keuken, beschreven voor snelle bestelkeuzes."
    },
    "cookingProfile": {
      "en": "Usually served as a meat with a tender meat, rich sauce feel.",
      "zh": "通常以meat形式上桌，重点体验是tender meat。",
    ...
    "orderVerdict": {
      "en": "Order when you want a very filling rustic dish.",
      "zh": "如果你接受这类口味和风险，法式豆焖肉 是可以优先考虑的选择。",
      "nl": "Een goede keuze als je deze smaak en risico’s prima vindt."
    },
    "spiceLevel": 0,
    "weightLevel": 4,
  ...
  starterDish({
    ...
    "shortDescription": {
      "en": "Raw minced beef seasoned and often served with egg yolk and fries.",
      "zh": "生牛肉塔塔 是常见法餐菜单菜品，重点适合用来判断口味、分量和点餐风险。",
      "nl": "Steak tartare is een veelvoorkomend gerecht in de frans keuken, beschreven voor snelle bestelkeuzes."
    },
    "cookingProfile": {
      "en": "Usually served as a meat with a tender meat, rich sauce feel.",
      "zh": "通常以meat形式上桌，重点体验是tender meat。",
    ...
    "avoidIfTags": [],
    "orderVerdict": {
      "en": "Only for diners comfortable with raw beef and egg.",
      "zh": "如果你接受这类口味和风险，生牛肉塔塔 是可以优先考虑的选择。",
      "nl": "Een goede keuze als je deze smaak en risico’s prima vindt."
    },
    "spiceLevel": 0,
    "weightLevel": 2,
  ...
  starterDish({
    ...
    "shortDescription": {
      "en": "Provençal fish soup or stew with seafood, broth, and aromatic seasoning.",
      "zh": "马赛鱼汤 是常见法餐菜单菜品，重点适合用来判断口味、分量和点餐风险。",
      "nl": "Bouillabaisse is een veelvoorkomend gerecht in de frans keuken, beschreven voor snelle bestelkeuzes."
    },
    "cookingProfile": {
      "en": "Usually served as a soup with a hot broth, soft pieces feel.",
      "zh": "通常以soup形式上桌，重点体验是hot broth。",
    ...
    "avoidIfTags": [],
    "orderVerdict": {
      "en": "Great seafood soup if fish and shellfish are welcome.",
      "zh": "如果你接受这类口味和风险，马赛鱼汤 是可以优先考虑的选择。",
      "nl": "Een goede keuze als je deze smaak en risico’s prima vindt."
    },
    "spiceLevel": 1,
    "weightLevel": 3,
  ...
  starterDish({
    ...
    "shortDescription": {
      "en": "Delicate fish cooked with butter, lemon, and parsley-style freshness.",
      "zh": "黄油煎鳎鱼 是常见法餐菜单菜品，重点适合用来判断口味、分量和点餐风险。",
      "nl": "Sole meunière is een veelvoorkomend gerecht in de frans keuken, beschreven voor snelle bestelkeuzes."
    },
    "cookingProfile": {
      "en": "Usually served as a seafood with a tender seafood, fresh finish feel.",
      "zh": "通常以seafood形式上桌，重点体验是tender seafood。",
    ...
    "avoidIfTags": [],
    "orderVerdict": {
      "en": "Good if you want refined fish without heavy spice.",
      "zh": "如果你接受这类口味和风险，黄油煎鳎鱼 是可以优先考虑的选择。",
      "nl": "Een goede keuze als je deze smaak en risico’s prima vindt."
    },
    "spiceLevel": 0,
    "weightLevel": 2,
  ...
  starterDish({
    ...
    "shortDescription": {
      "en": "Caramelized upside-down apple tart, usually buttery and sweet.",
      "zh": "反烤苹果塔 是常见法餐菜单菜品，重点适合用来判断口味、分量和点餐风险。",
      "nl": "Tarte tatin is een veelvoorkomend gerecht in de frans keuken, beschreven voor snelle bestelkeuzes."
    },
    "cookingProfile": {
      "en": "Usually served as a dessert with a sweet, soft feel.",
      "zh": "通常以dessert形式上桌，重点体验是sweet。",
    ...
    "avoidIfTags": [],
    "orderVerdict": {
      "en": "A classic dessert if you like caramelized fruit and pastry.",
      "zh": "如果你接受这类口味和风险，反烤苹果塔 是可以优先考虑的选择。",
      "nl": "Een goede keuze als je deze smaak en risico’s prima vindt."
    },
    "spiceLevel": 0,
    "weightLevel": 3,
  ...
  starterDish({
    ...
    "shortDescription": {
      "en": "Thin pancakes served sweet or savory with many fillings.",
      "zh": "法式薄饼 是常见法餐菜单菜品，重点适合用来判断口味、分量和点餐风险。",
      "nl": "Crêpes is een veelvoorkomend gerecht in de frans keuken, beschreven voor snelle bestelkeuzes."
    },
    "cookingProfile": {
      "en": "Usually served as a dessert with a sweet, soft feel.",
      "zh": "通常以dessert形式上桌，重点体验是sweet。",
    ...
    "avoidIfTags": [],
    "orderVerdict": {
      "en": "Flexible choice; filling decides whether it is light, rich, sweet, or savory.",
      "zh": "如果你接受这类口味和风险，法式薄饼 是可以优先考虑的选择。",
      "nl": "Een goede keuze als je deze smaak en risico’s prima vindt."
    },
    "spiceLevel": 0,
    "weightLevel": 2,
    ...
    "commonVariations": [
      {
        ...
        "note": {
          "en": "Can be sweet dessert or savory galette-style meal depending on filling.",
          "zh": "可做甜点，也可根据馅料变成咸味正餐。",
          "nl": "Kan zoet dessert zijn of hartige maaltijd afhankelijk van de vulling."
        }
      }
    ]
  }),
