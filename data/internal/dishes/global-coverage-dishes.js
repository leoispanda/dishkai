...
export const globalCoverageDishConfigs = groups.flatMap(([cuisineId, groupCode, startNumber, rows]) => {
  ...
  return rows.map(([id, en, zh, category], index) => {
    ...
    return {
      ...
      shortDescription: {
        en: `${en} is a recognizable ${cuisineEn} ${categoryLabel(category)}. This coverage card gives fast ordering context while restaurant versions may vary.`,
      ...
      goodForTags: ["coverage-expansion", "common-menu-item"],
