...
const auditedGeneratedDishIds = new Set([
  ...
  "stoofvlees",
  "paling-in-t-groen",
  "sirop-de-liege-dessert",
  "belgian-endive-salad",
  "tarte-al-djote",
  "potjevleesch",
  "boudin-blanc",
  "boudin-noir",
  "belgian-spaghetti-bolognese",
  "crevettes-grises-cocktail",
  "cod-with-leeks",
  "hesp-rolletjes",
  "kip-aan-t-spit",
  "lacquemants",
...
export const quarantinedDishes = [
  ...
  ...reviewedCompoundMenuMissDishes.filter((dish) => !verifiedDishIds.has(dish.id)),
