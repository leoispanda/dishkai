...
- Expansion Loop Europe 120 Pass V1 added 600 verified restaurant-menu coverage dishes and matching visual-reference assets, bringing Italian, Dutch, French, Greek, Spanish, German, Belgian, British-Irish, Portuguese, and Scandinavian coverage to 120 dishes each. The full database is now 1710 verified dishes / 4297 aliases. New data lives in `europe-120-depth-dishes.js` and `europe-120-depth-dish-aliases.js`; keep IDs and image paths ASCII and continue quality-auditing high-variation generic restaurant-menu items.
